...
const AdminRemoveListing = ({ navigation, route }) => {
        ...
        axios
            ...
            .then((response) => {
                ...
                if (status !== 'SUCCESS') {
                    ...
                    setSubmitting(false);
                    Alert.alert('SUCCESS', 'User listing has been deleted.', [
                ...
                <InnerContainer5>
                    <Formik
                        ...
                        onSubmit={(values, { setSubmitting }) => {
                            values = { ...values};
                            if (values.title == '') {
                                handleMessage('Please provide the email address of the user listing!');
                                setSubmitting(false);
                            } else {
                                    setSubmitting(true);
                    ...
                    >
                        {({ handleChange, handleBlur, handleSubmit, values, isSubmitting }) => (
                            <StyledFormArea>
                                ...
                                <MyTextInput
                                    label="Email Address of User Listing"
                                    icon="mail"
                                    placeholder="Email"
                                ...
                                {!isSubmitting && (
                                    <StyledButton1 onPress={handleSubmit}>
                                        <ButtonText>Remove Listing</ButtonText>
                                    </StyledButton1>
                                )}
