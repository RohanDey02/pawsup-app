...
Your Mark: 3
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 1.5
    Feedback: Spikes if any not identified 
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Broken down into tasks/subtasks (max 2 marks)
    ...
    Your Mark: 1
    Feedback: Only PLSGIB-19 and PLSGIB-1 broken down into subtasks
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 0
    Feedback: No acceptance criteria found 
...
## Tracking on Jira  (max 20 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Jira Active Sprint Board? (max 2 marks)
    ...
    Your Mark: 1.5 
    Feedback: PBSGIB-2 missing a pull request
...
Tracking on Jira Total Mark: 19.5 / 20
...
Comments:
- Buttons are too thick, maybe consider rounding them
- Available Services text colour is too light, hard to read
- BG on register doesn't go all the way down
