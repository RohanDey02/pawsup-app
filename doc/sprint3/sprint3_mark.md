...
## Planning Meetings (SR(N-1).md, sprintN.md) (max 2 marks)
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 1; did not mention anything about spikes
...
## System Design (PDF or MD file or another suitable format) (max 10 marks) 
  ...
  - Software Architecture Diagram (max 4 marks)
    ...
    Your Mark: 2; no link to three tiered architecture
...
## Sprint Demo (Max 14 marks) 
  ...
  - Look/consider text size for your headings and descriptions
  - If you have any areas that are interactable (ie. textboxes or dropdowns), include some visuals or outline to show that its interactable
    ie. The filter and sort right now looks like standard text and I wouldn't know at first if thats clickable
  - Remove confirmation for removing items/users etc. (in case you misclick)
